...
public final class Const {
	...
	*/ 
	 ...
	 * 운영서버 계정
	 */
	public static final String WITHDRAW_DB_URL = "jdbc:sqlserver://192.168.36.104:41433;DatabaseName=out_db";
	public static final String WITHDRAW_DB_ACCOUNT = "privacy_user";
	public static final String WITHDRAW_DB_PASSWORD = "xaKxBnFq1S!!";
	 ...
	 * 개발서버 계정
	 */
	public static final String WITHDRAW_TEST_DB_URL = "jdbc:sqlserver://192.168.16.151:1433;DatabaseName=out_db";
	public static final String WITHDRAW_TEST_DB_ACCOUNT = "privacy_user";
	public static final String WITHDRAW_TEST_DB_PASSWORD = "xaKxBnFq1S!!";
...
//사용 하지 않는 END
	...
	public static final String GSWAS_END_POINT = "https://group.gshnpoint.com:8030/gswas/was/"; 
	...
	//EV APP -> 신관제 변경으로 인한 URL 변경 / 2023.12.18 
	...
	public static final String WAS_EVAPP_END_POINT="http://172.12.51.238:80/api/extern/csc/";
	public static final String WAS_EVAPPTEST_END_POINT="http://172.12.33.251:80/api/extern/csc/";
	
	//TM(outbound)
	public static final String WAS_TM_END_POINT="https://192.168.29.50:443/complain/";
	public static final String WAS_TMTEST_END_POINT="https://192.168.16.50:443/complain/";
	
	//TM Point Cancel
	public static final String WAS_TM_PAYMENT_END_POINT="https://192.168.29.50:443/";
	public static final String WAS_TMTEST_PAYMENT_END_POINT="https://192.168.16.50:443/";
	
	//GSC VOC 수렴프로세스
	public static final String GSC_VOC_ACCESS_TOKEN = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJmcmVzaCI6ZmFsc2UsImlhdCI6MTcwMDYyOTM4NSwianRpIjoiMzRiOTk0NDQtMmVkMS00NDRiLWIzODctY2UyOGQ0NzBkY2Y3IiwidHlwZSI6ImFjY2VzcyIsInN1YiI6ImVwX2FwcF9hcGlfdG9rZW4iLCJuYmYiOjE3MDA2MjkzODUsInNjb3BlIjoiQVBJIn0.5jGQ0TC4Kw9-csYTITDwprTYS9Gjf6t0-Ni8UFC9q44";
	public static final String AWS_GSC_VOC_END_POINT="https://api-epvoc.gscaltex.co.kr/";
    ...
    //TM 암복호화 키 값
    public static  String  TM_PK = "VUTSRQPONMLKJIHGFEDCBA0987654321"; // 운영
    public static String   TM_PK_TEST = "1234567890ABCDEFGHIJKLMNOPQRSTUV"; // 개발
