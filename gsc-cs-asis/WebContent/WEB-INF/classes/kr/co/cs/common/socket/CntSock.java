...
public class CntSock
{
    ...
    private String RecvB() {
        try {
        	...
        	System.out.println("payment this Exception [" + e.toString() + " " + e.getMessage() + "]");        	
	...
	private void Close() {
		...
		try {if (sout != null) sout.close();	} catch (Exception e) {} 
		try {if (sin != null) sin.close();		} catch (Exception e) {} 
	}
}
