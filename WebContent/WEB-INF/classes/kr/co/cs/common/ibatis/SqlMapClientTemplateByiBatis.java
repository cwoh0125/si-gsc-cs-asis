 ...
 */
public class SqlMapClientTemplateByiBatis extends JdbcAccessor implements SqlMapClientOperationsByiBatis {
	 ...
	 */
	public SqlMapClientTemplateByiBatis() {
	}
	 ...
	 */
	public SqlMapClientTemplateByiBatis(SqlMapClient sqlMapClient) {
	 ...
	 * @param sqlMapClient iBATIS SqlMapClient that defines the mapped statements
	 */
	public SqlMapClientTemplateByiBatis(DataSource dataSource, SqlMapClient sqlMapClient) {
	 ...
	 */
	public Object execute(SqlMapClientCallback action) throws SQLException, DataAccessException {
...
//				DataAccessException dataAccessException = getExceptionTranslator().translate("SqlMapClient operation", null, ex);
				throw ex;
			}
			finally {
	 ...
	 * @throws DataAccessException in case of SQL Maps errors
	 */
	public List executeWithListResult(SqlMapClientCallback action) throws SQLException, DataAccessException {
	 ...
	 * @throws DataAccessException in case of SQL Maps errors
	 */
	public Map executeWithMapResult(SqlMapClientCallback action) throws SQLException, DataAccessException {
