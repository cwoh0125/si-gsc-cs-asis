...
public class NiceNameAuthentication {
    ...
    public void setChkName(String s)
    {
        ...
        catch(ClassCastException ce) { errlogger.debug("exception ::" + ce.getMessage());}
        catch(Exception exception) { errlogger.debug("exception ::" + exception.getMessage());}
    }

    public String setJumin(String s) throws NoSuchAlgorithmException
    {
        Jumin = s.trim();
    ...
    private String getNameCheck()
    {
        ...
        catch(MalformedURLException malformedurlexception)
        {
            ...
            if(inputstream != null)
                ...
                catch(IOException exception2) { errlogger.debug("exception ::" + exception2.getMessage());}
            if(socket != null)
                try
                {
                    socket.close();
                ...
                catch(IOException exception3) { errlogger.debug("exception ::" + exception3.getMessage());}
            s = "62";
        }
        catch(NoRouteToHostException noroutetohostexception)
        {
            ...
            if(inputstream != null)
                ...
                catch(IOException exception5) { errlogger.debug("exception ::" + exception5.getMessage());}
            if(socket != null)
                try
                {
                    socket.close();
                ...
                catch(IOException exception6) { errlogger.debug("exception ::" + exception6.getMessage());}
            s = "61";
        }
        catch(Exception exception)
        {
            ...
            if(inputstream != null)
                ...
                catch(IOException exception8) {errlogger.debug("exception ::" + exception8.getMessage()); }
            if(socket != null)
                try
                {
                    socket.close();
                ...
                catch(IOException exception9) { errlogger.debug("exception ::" + exception9.getMessage());}
            s = "63";
        }
        finally
        {
            ...
            if(inputstream != null)
                ...
                catch(IOException exception12) { errlogger.debug("exception ::" + exception12.getMessage());}
            if(socket != null)
                try
                {
                    socket.close();
                ...
                catch(IOException exception13) { errlogger.debug("exception ::" + exception13.getMessage());}
        }
        return s;
    }

    private int getEncJumin(String s, int i) throws NoSuchAlgorithmException
    {
